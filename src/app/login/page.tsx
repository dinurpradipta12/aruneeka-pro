  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 md:p-10 font-inter selection:bg-amethyst-primary selection:text-white relative overflow-hidden transition-opacity duration-300 ${isMounted ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <motion.div 
        ...
        className="w-full max-w-6xl aspect-video min-h-[600px] bg-white/90 backdrop-blur-md rounded-[48px] shadow-[0_32px_80px_-20px_rgba(0,0,0,0.3)] border border-white/20 overflow-hidden flex flex-col md:flex-row relative z-10"
      >
        ...
        <div className="flex-1 bg-white p-12 md:p-20 flex flex-col justify-center relative">
